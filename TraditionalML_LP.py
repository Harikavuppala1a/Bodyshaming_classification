...
def train(data_dict,conf_dict_com):
    ...
    if(conf_dict_com['MODEL_TYPE'] != "all"):
        # print (MODEL_TYPE)
        classification_model(train_features, test_features, data_dict['lab'][data_dict['train_st_ind']:data_dict['train_en_ind']], data_dict['lab'][data_dict['test_st_ind']:data_dict['test_en_ind']], conf_dict_com['MODEL_TYPE'])
    else:
        for model_name in conf_dict_com['models']:
            print (model_name)
            classification_model(train_features, test_features, data_dict['lab'][data_dict['train_st_ind']:data_dict['train_en_ind']], data_dict['lab'][data_dict['test_st_ind']:data_dict['test_en_ind']], model_name)
